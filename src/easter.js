...
const eggs = [
    ...
    },
    {
        ...
        "func": threadId => {
            utils.sendMessage({
                "url": "https://youtu.be/NGm2hyI3_z8"
            }, threadId);
        }
    },
    {
        "regex": /subaru/i,
        "func": threadId => { utils.sendFile("../media/subaru.jpg", threadId); }
    },
    {
        "regex": /how do you know its shit/i,
        "func": threadId => { utils.sendFile("../media/how_do_you_know.jpg", threadId); }
    },
    {
        "regex": /pretending to be a retard/i,
        "func": threadId => { utils.sendFile("../media/pretending_retard.jpg", threadId); }
    },
    {
        "regex": /shrug/i,
        ...
        "func": (threadId, _, __, groupInfo) => { 
            switch (groupInfo.tellmewhystate) {
                case '0':
                    ...
                    utils.setGroupProperty("tellmewhystate", '1', groupInfo);
                    break;
                case '1':
                    utils.sendMessage(`♪♫ Ain't nothing but a mistake ♫`, threadId); 
                    utils.setGroupProperty("tellmewhystate", '2', groupInfo);
                    break;
                case '2':
                    ...
                    utils.setGroupProperty("tellmewhystate", '0', groupInfo);
                    break;
                default:
