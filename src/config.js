...
exports.owner = {
    ...
    "id": "1099454173" // ID of bot owner (for secure commands, reports, and alerts)
};

// Bot information
exports.bot = {
    "names": {
        "short": "LPM Peacekeeper 2000", // Will be used as 'nickname' in chat (remove if same as account name)
        "long": "Lpm-PeacekeeperUltra Dredd" // Name displayed in profile on bot's Facebook account
    },
    "id": "100065739395341" // Bot's ID (for security purposes in commands)
};
